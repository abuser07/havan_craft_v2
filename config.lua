Config = {
    images = 'https://orbitrp.top/itens/',
    storeLink = 'https://orbitrp.top/',
    dirtymoney = 'dinheirosujo',
    
    Tables = {


        -- Adicione dentro de Config.Tables = {




-- =========================================================================
-- FERRAMENTAS (Bancada de Ferramentas - Sem Permissão)
-- Localização: 548.821960, -188.716476, 54.470337
-- =========================================================================
-- =========================================================================
-- JAPONÊS (Restaurante de Comida Japonesa)
-- Localização: Escolha uma coordenada para o restaurante
-- =========================================================================
-- =========================================================================
    ...
    locations = {
        {
            ...
            tablePermission = nil,  -- Público (qualquer um pode usar)
            craftPermission = nil,   -- Público
...
['Japones'] = {
    ...
    locations = {
        {
            name = 'Japones',
            coords = vec3(-1842.751587, -1186.259399, 14.317261), -- Ajuste a coordenada conforme necessário
            requireStorage = { active = true, name = 'Japones' },
            tablePermission = 'japones.permissao', -- Ou nil se quiser público
            craftPermission = 'japones.permissao',
            drawMarker = function(coords, dist)
                if dist <= 5.0 then
...
['Ferramentas'] = {
    craft = {
        --[[
        ['Ferramentas'] = { ['pneu'] = 9999, ['weapon_wrench'] = 9999, ['weapon_crowbar'] = 9999, ['rastreador'] = 9999}
        ]]
        {
            item = 'pneu',
            amount = 1,
        ...
        },
        {
            ...
            requires = {
                ...
                { item = "aco", amount = 3 }  -- Se 'aco' não existir, use 'ferro'
            }
        },
        {
            item = 'rastreador',
...
-- =========================================================================
-- EQUIPAMENTOS (Bancada de Equipamentos - Sem Permissão)
-- Localização: 716.162659, -964.048340, 30.391968
-- =========================================================================
--[[ ["Equipamentos"]
tecido
couro
...
['Equipamentos'] = {
    ...
    locations = {
        ...
        -- =========================================================================
        -- ARMAS (Bancada de Armas)
        -- Permissão: armas.permissao
        -- =========================================================================
        ['Armas'] = {
            craft = {
                {
            ...
            locations = {
                {
                    ...
                    tablePermission = 'armas.permissao',
                    craftPermission = 'armas.permissao',
                    drawMarker = function(coords, dist)
                        if dist <= 5.0 then
        ...
        -- =========================================================================
        -- MUNIÇÃO (Bancada de Munição)
        -- Permissão: municao.permissao
        -- =========================================================================
        ['Municao'] = {
            craft = {
                {
            ...
            locations = {
                {
                    name = 'MotoClub', -- MOTOCLUB
                    coords = vec3(5141.433105, -4962.105469, 14.283569),
                    requireStorage = { active = true, name = 'MotoClub' },
                    tablePermission = 'municao.permissao',
                    craftPermission = 'municao.permissao',
                    drawMarker = function(coords, dist)
                        if dist <= 5.0 then
                            DrawText3Ds(coords.x, coords.y, coords.z + 0.1, 'Pressione ~p~[E]~w~ para acessar a bancada.')
                            DrawMarker(27, coords.x, coords.y, coords.z - 0.95, 0, 0, 0, 0, 0, 0, 1.5, 1.5, 1.5, 132, 102, 226, 180, 0, 0, 0, 1)
        ...
        -- =========================================================================
        -- DESMANCHE (Bancada de Desmanche)
        -- Permissão: desmanche.permissao
        -- =========================================================================
        ['Desmanche'] = {
            craft = {
                {
            ...
            locations = {
                {
                    ...
                    tablePermission = 'desmanche.permissao',
                    craftPermission = 'desmanche.permissao',
                    drawMarker = function(coords, dist)
                        if dist <= 5.0 then
                            DrawText3Ds(coords.x, coords.y, coords.z + 0.1, 'Pressione ~p~[E]~w~ para acessar a bancada.')
                            DrawMarker(27, coords.x, coords.y, coords.z - 0.95, 0, 0, 0, 0, 0, 0, 1.5, 1.5, 1.5, 132, 102, 226, 180, 0, 0, 0, 1)
        ...
        -- =========================================================================
        -- MECÂNICA (Bancada de Mecânica)
        -- Permissão: mecanica.permissao
        -- =========================================================================
        ['MECANICA'] = {
            craft = {
                {
            ...
            locations = {
                {
                    ...
                    tablePermission = 'mecanica.permissao',
                    craftPermission = 'mecanica.permissao',
                    drawMarker = function(coords, dist)
                        if dist <= 5.0 then
                            DrawText3Ds(coords.x, coords.y, coords.z + 0.1, 'Pressione ~p~[E]~w~ para acessar a bancada.')
                            DrawMarker(27, coords.x, coords.y, coords.z - 0.95, 0, 0, 0, 0, 0, 0, 1.5, 1.5, 1.5, 132, 102, 226, 180, 0, 0, 0, 1)
        ...
        -- =========================================================================
        -- DROGAS (Bancada de Drogas)
        -- Permissão: drogas.permissao
        -- =========================================================================
        ['Drogas'] = {
            craft = {
                {
            ...
            locations = {
                {
                    ...
                    tablePermission = 'drogas.permissao',
                    craftPermission = 'drogas.permissao',
                    drawMarker = function(coords, dist)
                        if dist <= 5.0 then
                            DrawText3Ds(coords.x, coords.y, coords.z + 0.1, 'Pressione ~p~[E]~w~ para acessar a bancada.')
                            DrawMarker(27, coords.x, coords.y, coords.z - 0.95, 0, 0, 0, 0, 0, 0, 1.5, 1.5, 1.5, 132, 102, 226, 180, 0, 0, 0, 1)
        ...
        --             itemTime = 15,
        --             requires = {
        --                 { item = "dinheirosujo", amount = 100000 },
        ...
        --             itemTime = 15,
        --             requires = {
        --                 { item = "dinheirosujo", amount = 200000 },
        --                 { item = "l-alvejante", amount = 25 }
        --             }
        --         },
        --         {
        ...
        --             itemTime = 20,
        --             requires = {
        --                 { item = "dinheirosujo", amount = 300000 },
        ...
        --             tablePermission = 'lavagem.permissao',
        --             craftPermission = 'lavagem.permissao',
        --             drawMarker = function(coords, dist)
        --                 if dist <= 5.0 then
        --                     DrawText3Ds(coords.x, coords.y, coords.z + 0.1, 'Pressione ~p~[E]~w~ para acessar a bancada.')
        --                     DrawMarker(27, coords.x, coords.y, coords.z - 0.95, 0, 0, 0, 0, 0, 0, 1.5, 1.5, 1.5, 132, 102, 226, 180, 0, 0, 0, 1)
...
['BurguerShot'] = { 
    itens = { 
        ...
        -- Produtos finais (para estoque se necessário)
        ['hamburguer'] = 9999999,
        ...
        -- LAVAGEM
        ['Iluminatis'] = { itens = { ['dinheirosujo'] = 9999999, ['l-alvejante'] = 9999999, ['pacote_tecido'] = 9999999, ['c-ferro'] = 9999999, ['m-aco'] = 9999999 } },
        ['Vanilla'] = { itens = { ['dinheirosujo'] = 9999999, ['l-alvejante'] = 9999999, ['pacote_tecido'] = 9999999, ['c-ferro'] = 9999999, ['m-aco'] = 9999999 } },
        ['camora'] = { itens = { ['dinheirosujo'] = 9999999, ['l-alvejante'] = 99999999, ['pacote_tecido'] = 9999999, ['c-ferro'] = 9999999, ['m-aco'] = 9999999 } },
        ['camoradois'] = { itens = { ['dinheirosujo'] = 9999999, ['l-alvejante'] = 999999, ['pacote_tecido'] = 9999999, ['c-ferro'] = 9999999, ['m-aco'] = 9999999 } },
        ['Tequila'] = { itens = { ['dinheirosujo'] = 9999999, ['l-alvejante'] = 999999, ['pacote_tecido'] = 9999999, ['c-ferro'] = 9999999, ['m-aco'] = 9999999 } },
